...
public class Game {
  ...
  private final int bossDamage = zombie1.getDamage() + 20;
  ...
  public void startGame() {
    ...
    System.out.println(
        ConsoleColors.CYAN + "Would you like to begin the game? y/n" + ConsoleColors.RESET);
    ...
    if (command.equals("y")) {
      ...
      System.out.println(
          ConsoleColors.BRIGHT_YELLOW + "Invalid command. Please enter y/n" + ConsoleColors.RESET);
      startGame();
    }
  }
  ...
  private void playerName() {
    ...
    if (userName.equals("quit")) {
      System.out.println(
          ConsoleColors.BLUE + "I guess you didn't want to play." + ConsoleColors.RESET);
    }
  }
  ...
  public void processCommand(String commandString) {
    ...
    if (command[0].equals("help")) {
      ...
      System.out.println(
          ConsoleColors.BRIGHT_RED + ConsoleColors.BOLD + "invalid input, please try again!"
              + ConsoleColors.RESET);
      ...
      System.out.println(
          ConsoleColors.BRIGHT_RED + "Invalid command. Please enter valid game command such as: \n"
              + ConsoleColors.RESET
...
//    };
    int playerHealth = player.getHealth();
    Location currentLocation = gameMap.get(player.getLocation());
    if (command[1].equals("crossbow") && currentLocation.getLocationName()
    ...
    } else if (command[1].equals("spiked-bat") && currentLocation.getLocationName()
        .equals("zombie motel caves")) {
    ...
    } else if (command[1].equals("gun") && currentLocation.getLocationName()
        .equals("zombie motel caves")) {
      zombie2.setHealth(zombie2.getHealth() - 50);
      zombie2.setLocation("zombie dump");
      newItem.remove("gun");
      System.out.println("You killed the Zombie!");
        ...
        .equals("boss room") && player.getHealth() > 100) {
  ...
  private void movePlayer(String[] command, Location currentLocation) {
    ...
    if (command[1].equals("north")) {
      ...
      System.out.println(
          ConsoleColors.YELLOW + "Not a valid direction, try another!" + ConsoleColors.RESET);
    }
  ...
  public void addToInventory() {
    ...
    if (!item.isEmpty() && !newItem.contains(item)) {
      ...
      System.out.println(ConsoleColors.PURPLE + newItem.get(0) + ConsoleColors.RESET
  ...
  private void talkToNpc() {
    ...
    if (currentLocation.getNpc().isEmpty()) {
      System.out.println(
          ConsoleColors.BLUE + "There is no one to talk to.\n" + ConsoleColors.RESET);
    } else {
      System.out.println(
          ConsoleColors.BLUE + currentLocation.getNpc() + " says: " + ConsoleColors.RESET
              + currentLocation.getNpcQuote());
    }
  }
  ...
  public void winOrLose() {
    ...
    if (currentLocation.getLocationName().equals("safe haven")) {
      System.out.println(
          ConsoleColors.BRIGHT_GREEN + "You are now Safe! Congratulations, this is your new life."
              + ConsoleColors.RESET);
      setState(State.WIN);
    } else if (currentLocation.getLocationName().equals("safe haven") && newItem.contains(
        "portal note")) {
      System.out.println(ConsoleColors.BRIGHT_GREEN
          + "You are a kind man! You saved everyone, thank you for being you!"
          + ConsoleColors.RESET);
      setState(State.WIN);
    } else if (player.getHealth() <= 0) {
      setState(State.LOSE);
      System.out.println(
          ConsoleColors.BRIGHT_RED + "Better luck next time! You DIED!" + ConsoleColors.RESET);
    } else if (currentLocation.getLocationName().equals("not deadly depths")) {
      System.out.println(
          ConsoleColors.BRIGHT_RED + "You took a wrong turn! You DIED!" + ConsoleColors.RESET);
      setState(State.LOSE);
    } else if (currentLocation.getLocationName().equals("toxic river") && !newItem.contains(
        "raft")) {
      System.out.println(ConsoleColors.BRIGHT_RED
          + "You forgot the raft! The river was too toxic and so was your thinking. You DIED!"
          + ConsoleColors.RESET);
      setState(State.LOSE);
  ...
  public void statusUpdate() {
    Location currentLocation = gameMap.get(player.getLocation());
    System.out.println("You are currently at: " + ConsoleColors.PURPLE + ConsoleColors.BOLD
        + currentLocation.getLocationName() + "\n" + ConsoleColors.RESET);
    System.out.println(currentLocation.getDescription());
    showNPC();
    showPossibleDirections();
    System.out.println(
        "\n" + player.getName() + ", your current health is = " + ConsoleColors.BRIGHT_RED
            + player.getHealth() + "\n" + ConsoleColors.RESET);
    showItems();
    showInventory();
  }
  ...
  public void showInventory() {
    if (player.getInventory() == null) {
      ...
      System.out.println(
          "Your inventory currently has: " + ConsoleColors.BRIGHT_BLUE + player.getInventory()
              + ConsoleColors.RESET);
    }
  }
  ...
  public void showItems() {
    ...
    if (!item.isEmpty() && !newItem.contains(item)) {
      ...
      System.out.println(
          ConsoleColors.BRIGHT_CYAN + "You see no items in this area. \n" + ConsoleColors.RESET);
    }
  }
  ...
  public void showNPC() {
    ...
    if (!currentLocation.getNpc().isEmpty()) {
      System.out.println(
          ConsoleColors.BLUE + "NPC: " + currentLocation.getNpc() + "\n" + ConsoleColors.RESET);
    } else {
      System.out.println(
          ConsoleColors.BLUE + "NPC: No characters at this location. \n" + ConsoleColors.RESET);
    }
  }
  ...
  public void showZombies() {
    ...
    if (zombie1.getLocation().equals(currentLocation.getLocationName()) && !newItem.isEmpty()) {
      System.out.println(ConsoleColors.BRIGHT_YELLOW
          + "There is a zombie! It has struck you! Defend yourself or cry... I mean die!\n"
          + ConsoleColors.RESET);
    } else if (zombie1.getLocation().equals(currentLocation.getLocationName())
        && newItem.isEmpty()) {
      System.out.println(ConsoleColors.BRIGHT_YELLOW
          + "There is a zombie! It has struck you! You had nothing to defend yourself, YOU DIED!\n"
          + ConsoleColors.RESET);
      ...
      System.out.println(ConsoleColors.BRIGHT_YELLOW
          + "There are two zombies in this room... This is not looking good for you.\n"
          + ConsoleColors.RESET);
    } else if (bossZombie.getLocation().equals(currentLocation.getLocationName())) {
      System.out.println(ConsoleColors.BRIGHT_YELLOW
          + "This is a baby zombie? What harm could it do? \n Your health must be more than 100! \n"
  ...
  public void showPossibleDirections() {
    ...
    if (currentLocation.getNorth().isEmpty()) {
      ...
      System.out.println(
          "North: " + ConsoleColors.BRIGHT_CYAN + currentLocation.getNorth() + ConsoleColors.RESET);
    }
    ...
    if (currentLocation.getSouth().isEmpty()) {
      ...
      System.out.println(
          "South: " + ConsoleColors.BRIGHT_CYAN + currentLocation.getSouth() + ConsoleColors.RESET);
    }
    ...
    if (currentLocation.getWest().isEmpty()) {
      ...
      System.out.println(
          "West: " + ConsoleColors.BRIGHT_CYAN + currentLocation.getWest() + ConsoleColors.RESET);
    }
    ...
    if (currentLocation.getEast().isEmpty()) {
      ...
      System.out.println(
          "East: " + ConsoleColors.BRIGHT_CYAN + currentLocation.getEast() + ConsoleColors.RESET);
    }
